...
DATA_DIR = "/data"
OUTPUT_DIR = "/output"
TEMPLATE_DIR = os.path.join(ROOT, "pdf_template")
...
def process_all():
    ...
    for file in os.listdir(DATA_DIR):
        ...
        text = strip_times("".join(pytesseract.image_to_string(img) for img in convert_from_path(path))).upper()
        ...
        groups = group_manifests(parse_rows(text, year_from_filename(file)))
